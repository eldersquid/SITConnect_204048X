<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TwoFactorAuthentication.aspx.cs" Inherits="SITConnect_204048X.TwoFactorAuthentication" %>
    ...
    <div class="container h-100">
      <div class="row d-flex justify-content-center align-items-center h-100">
        ...
        <div>
            ...
            <asp:Image ID="barcodeURL" class="form-label" runat="server" />
            ...
            <div class="form-outline ">
                  Setup code:
                <asp:Label ID="setupCodeText" class="form-label" runat="server" Text="">
                </asp:Label>
                    </div>
