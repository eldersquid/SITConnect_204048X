<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="error403.aspx.cs" Inherits="SITConnect_204048X.error403" %>
...
<div class="terminal">
  ...
  <p class="output">Forbidden: Access is denied. You do not have permission to view this directory or page using the credentials that you supplied.</p>
  <p class="output">Please <a href="Login.aspx">return to login.</a>.</p>
